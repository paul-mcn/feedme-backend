        ...
        Query: {
            ...
            suggestedMeals: async (parent, args, context) => {
                ...
                try {
                    ...
                    const currentDate = (0, utils_1.getUnixFromTimestamp)();
                    const hasExpired = (0, utils_1.getUnixFromTimestamp)(expiryDate) < currentDate;
                    const meals = await database.getMeals();
                    if (!ids || hasExpired) {
                        const newSuggestedMeals = (0, utils_1.filterRandomMeals)(meals, 7);
